...
// import Icon from "../../../../Desktop/projects/personal/MusicPlayer/src/components/icon";

const AnimatedView = Animated.View;

console.log('animated-views:', {
  AnimatedView: Boolean(AnimatedView),
  Animated: Boolean(Animated),
  'Animated.View': Boolean(Animated.View),
});
    ...
    return (
      <AnimatedView
        ...
        <Image
          ...
          source={{
            uri: 'https://i.insider.com/5a79caf2f9d4131b008b48e1?width=1136&format=jpeg',
          }}
        />
      </AnimatedView>
    );
